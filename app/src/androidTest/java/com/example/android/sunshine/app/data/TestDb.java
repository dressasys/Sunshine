...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        long locationRowId;
        locationRowId = TestUtilities.insertLocation(db, WeatherContract.LocationEntry.TABLE_NAME);
    ...
    public void testWeatherTable() {
        ...
        long locationKey = TestUtilities.insertLocation(db, WeatherContract.LocationEntry.TABLE_NAME);

        // Create ContentValues of what you want to insert
        // (you can use the createWeatherValues TestUtilities function if you wish)
        ContentValues testValues = TestUtilities.createWeatherValues(locationKey);
